        ...
        <div class="card">
          ...
          <!-- <form action="" method="post"> -->
            ...
            <div class="card-body">
              ...
              <div class="card text-white mb-5 beforeCheck" style="width: 100%; background-color: #67d680; cursor:pointer" onclick="send('2')">
                <div class="card-header">
              ...
              <div class="card-footer afterCheck" style="display:none;">
                <button type="button" class="btn btn-success" onclick="saveFeedback()">Юбориш</button>
              </div>
